...
# Streamlit app
#st.set_page_config(page_title="美弛（财商）投资",page_icon=":rainbow:",layout="wide",initial_sidebar_state="auto")

def app():

    #st.sidebar.title('美弛（财商）投资:heart:')
    ...
    def fetch_stock_data(stock_code):
        try:
            df = ak.stock_zh_a_hist(symbol=stock_code, period="daily", start_date="20241008", end_date="20250107",adjust="")
    ...
    # Calculate RSI
        ...
        # Create subplot
        fig = make_subplots(rows=2, cols=1, shared_xaxes=True, vertical_spacing=0.1, subplot_titles=('股价','RSI'),row_heights=[0.7, 0.3])
